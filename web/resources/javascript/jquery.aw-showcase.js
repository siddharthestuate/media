...
(function(jQuery) {
	...
	jQuery.fn.awShowcase = function(options) {
		...
		if (options.thumbnails)
		{
			...
			if (options.thumbnails_direction !== 'horizontal')
			{
				buttonBackward.html('<span class="showcase-thumbnail-vertical scrollUp"><span>Up</span></span>');
			}
			else
			{
			...
			if (options.thumbnails_direction !== 'horizontal')
			{
				buttonForward.html('<span class="showcase-thumbnail-vertical scrollDown"><span>Down</span></span>');
			}
			else
			{
